  ...
  return (
    <section className={classes['hero-wrapper']} id="about">
      ...
      <ul className={classes['socials-wrapper']}>
        <li>
          <a href="https://github.com/VlahOff" className={classes['social-link']} target='_blank'>
            <i className="fa-brands fa-github"></i>
          </a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/dimitar-vlahov-04b829227/" className={classes['social-link']} target='_blank'>
